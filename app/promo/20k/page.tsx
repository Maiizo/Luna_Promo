...
export default function Promo20kPage() {
...
const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/promo/20k', {
        method: 'POST',
        headers: {
      ...
      if (result.success) {
        setVoucherCode('20K-' + randomCode); // Tampilkan QR di layar
      } else {
